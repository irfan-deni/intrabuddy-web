  ...
  <div class="min-h-screen flex items-center justify-center bg-brand-bg px-6">
    <div class="w-full max-w-md">
      <div class="text-center mb-10">
        ...
        <h1 class="text-2xl font-black uppercase tracking-tight text-brand-navy">INTRA Buddy</h1>
        <p class="text-text-muted mt-2 text-[10px] font-black uppercase tracking-widest">Sign in to manage your cohort</p>
      </div>
      ...
      <form class="space-y-4" @submit.prevent="handleLogin">
        <div>
          <label class="text-[9px] font-black text-text-muted uppercase tracking-widest block mb-2">Email Address</label>
          <input
            v-model="email"
            type="email"
            required
        ...
        <div>
          <label class="text-[9px] font-black text-text-muted uppercase tracking-widest block mb-2">Password</label>
          <input
            v-model="password"
            type="password"
            required
      ...
      <div class="mt-8 pt-8 border-t border-slate-100 text-center text-[9px] font-black text-text-veryMuted uppercase tracking-widest">
